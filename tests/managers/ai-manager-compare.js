/**
 * Version comparison script for AIManager
...
const originalCode = fs.readFileSync(
    path.join(__dirname, '../../js/managers/AIManager.js'),
    'utf-8'
);
const refactoredCode = fs.readFileSync(
    path.join(__dirname, '../../js/managers/AIManager.refactored.js'),
    'utf-8'
);
...
// Run tests
console.log('\n========================================');
console.log('AIManager Version Comparison');
console.log('========================================\n');
...
fs.writeFileSync(path.join(__dirname, 'ai-manager-comparison-results.json'), JSON.stringify(summary, null, 2));
console.log(`Results saved to: ai-manager-comparison-results.json\n`);
